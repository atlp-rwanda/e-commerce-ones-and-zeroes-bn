...
import { ProductNotification, collectionNotification, ProductAvailableNotification } from "../utils/notifications/saveToDb";
...
describe("collectionNotification", () => {
    ...
    it("should log an error if notification creation fails", async () => {
        ...
        expect(consoleErrorSpy).toHaveBeenCalledWith("error creating notification:", mockError);
