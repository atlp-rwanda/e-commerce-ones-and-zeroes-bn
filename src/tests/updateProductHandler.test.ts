...
import { updateProductEmitter } from '../utils/notifications/eventEmittersModule';
...
describe('updateProduct', () => {
  ...
  beforeAll(() => {
    ...
    require('../utils/notifications/updateProductHandler');
  });
  ...
  test('should call sendMail with correct email options', async () => {
    ...
    await updateProductEmitter.emit('update', {
      product,
      userInfo,
      productStatus,
    });
